...
const BLOG = {
  ...
  REVALIDATION_TOKEN: process.env.REVALIDATION_TOKEN || '', // On-Demand Revalidation Token，设置后可通过 POST /api/revalidate 立即刷新页面缓存
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'felixfixit', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '创新嵌入式电子科技', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.felixmicrospace.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, embeded', // 网站关键词 英文逗号隔开
